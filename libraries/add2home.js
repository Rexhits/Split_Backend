var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			message: 'Stay updated for more tests! Tap %icon and then <strong>Add to Home Screen</strong> to add a shortcut to the Home Screen of your %device.',				// Customize your message or force a language ('' = automatic)
